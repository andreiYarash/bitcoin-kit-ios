...
public struct VarInt_Local_Usage : ExpressibleByIntegerLiteral {
    ...
    static public func deserialize(_ data: Data) -> VarInt_Local_Usage {
        return data.to_Local_Usage(type: self)
    }
}

extension VarInt_Local_Usage : CustomStringConvertible {
