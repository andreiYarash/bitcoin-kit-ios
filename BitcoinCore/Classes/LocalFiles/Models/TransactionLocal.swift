import Foundation
public enum TransactionStatus_Local_Usage: Int, Codable { case new, relayed, invalid }

public class Transaction_Local_Usage {
    ...
    public var status: TransactionStatus_Local_Usage = .relayed
