...
public class BitcoinManager {
    ...
    public func buildForSign(target: String, amount: Int, feeRate: Int, sortType: TransactionDataSortType_Local_Usage = .bip69, changeScript: Data?, sequence: Int? = nil) throws -> [Data] {
    ...
    public func buildForSend(target: String, amount: Int, feeRate: Int, sortType: TransactionDataSortType_Local_Usage = .bip69, derSignatures: [Data], changeScript: Data?, sequence: Int? = nil) throws -> Data {
        //let amount = convertToSatoshi(value: amount)
