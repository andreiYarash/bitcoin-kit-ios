import Foundation
public enum ScriptType_Local_Usage: Int {
...
public class Output_Local_Usage {
    ...
    public var scriptType: ScriptType_Local_Usage = .unknown
    ...
    public func set(publicKey: PublicKey_Local_Usage) {
        self.publicKeyPath = publicKey.path
        self.changeOutput = !publicKey.external
    }

    public init(withValue value: Int, index: Int, lockingScript script: Data, transactionHash: Data = Data(), type: ScriptType_Local_Usage = .unknown, redeemScript: Data? = nil, address: String? = nil, keyHash: Data? = nil, publicKey: PublicKey_Local_Usage? = nil) {
        self.value = value
