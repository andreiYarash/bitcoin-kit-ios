class Bip69_Local_Usage {

    static var outputComparator: ((Output_Local_Usage, Output_Local_Usage) -> Bool) = { o, o1 in
        if o.value != o1.value {
    ...
    static var inputComparator: ((UnspentOutput_Local_Usage, UnspentOutput_Local_Usage) -> Bool) = { o, o1 in
        let result = Bip69_Local_Usage.compare(data: o.output.transactionHash, data2: o1.output.transactionHash)
